(function () {
  ...
  const countryContexts = {
    ...
    denmark:
      "Denmark separates national handling of research misconduct by the Danish Board on Research Misconduct (NVU, from the Danish name Naevnet for Videnskabelig Uredelighed) from local institutional handling of questionable research practice and returned cases.",
    finland:
      "Finland has a national TENK 2023 research-integrity procedure with institutional first-instance responsibilities and a national second-line statement route. Local university procedures, such as Helsinki's Chancellor route, should be separated from TENK national statement summaries.",
    france:
  ...
  const countryCodeSources = {
    ...
    denmark: {
      ...
      note: "Replaces the 2014 edition and sits beside the statutory Danish Board/NVU route."
    },
    finland: {
  ...
  const countryBoundaryRegimes = {
    ...
    finland: [
      "TENK national second-line RI statement route",
      "medical research ethics under the Medical Research Act",
      "human-sciences ethical pre-assessment under TENK guidance",
      "nature and environment ethics under the 2026 NERE recommendation",
  ...
  const publicOutputCategoryNotesById = {
    ...
    "university-of-helsinki": "University of Helsinki member validation confirms that public output is TENK national statement-summary reporting after local processes; no Helsinki-owned annual RI statistics, anonymized local decisions or institution-specific TENK summary route is public.",
  ...
  window.LERU_MEMBER_DATA = [
    ...
    member({
      ...
      reportStatus: "Detailed seed",
      profileStatus: "Transparency seed from existing project data",
      validationStatus: "Danish reviewer validation confirms UCPH route; NVU terminology clarified",
      evidenceLevel: "Strong",
      transparencyCategory: "Practice Committee annual reports and minutes",
      institutionalRoute:
        "The Practice Committee assesses responsible-conduct issues, receives complaints, publishes rules, annual reports and meeting minutes, handles cases returned from the Danish Board on Research Misconduct (NVU) and can refer suspected research misconduct to that national Board.",
      ...
      caveats: ["Do not merge UCPH local QRP publication with Danish Board on Research Misconduct (NVU) national research-misconduct publication."],
      reportNotes: [
        "Updated on 2 July 2026 from Danish reviewer validation: the Denmark/UCPH substance is correct, but NVU is expanded for non-Danish readers and the current statutory route is described as research misconduct."
      ],
    ...
    member({
      ...
      reportStatus: "Detailed seed",
      profileStatus: "Detailed national-output/no-local-output audit seed",
      validationStatus: "Updated with University of Helsinki member validation on TENK route, adviser role and no-local-output finding",
      evidenceLevel: "Strong",
      transparencyCategory: "Chancellor route under TENK 2023; national TENK output only",
      nationalRoute:
        "Helsinki sits in the Finnish TENK 2023 research-integrity model. TENK defines the scope, violation categories and process framework, while the University handles first-instance allegations locally through the Chancellor route. TENK remains a national second-line statement route after the institutional process, and its anonymized summaries should not be treated as Helsinki-owned output unless a summary is explicitly institution-specific.",
      institutionalRoute:
        "The University of Helsinki route sets out the TENK-aligned research-integrity process: confidential adviser support is available before or around a formal allegation, but advisers do not investigate or decide cases. Allegations are submitted in writing to the Chancellor, who initiates a preliminary inquiry and decides whether a full investigation is needed.",
      committeeOrOffice: "Research-integrity advisers for confidential support; Chancellor notification route for formal allegations",
      procedureSummary:
        "UH applies the TENK 2023 RI guideline rather than a separate local classification system. The guideline covers research and RDI activities across disciplines and lifecycle phases; distinguishes research misconduct such as fabrication, falsification, plagiarism and misappropriation from disregard for good research practices such as negligence, inadequate referencing and poor data management; and sets a process of written allegation, preliminary inquiry, investigation proper if required and possible TENK statement request after the institutional process.",
      publicOutputSummary:
        "University of Helsinki member validation confirms that UH does not publish local annual RI statistics, anonymized local decisions or a public local case archive. TENK publishes national anonymized statement summaries, but these are not institution-specific and should remain classified as national-level output only.",
      transparencySummary:
        "Helsinki is a clear local first-instance route inside the TENK model, but public transparency remains national-summary-based rather than Helsinki-owned local reporting.",
      sourceCoverage: {
        institutionalProcedure: "available",
        committeePage: "available",
      ...
      sourceLinks: [
        {
          ...
          type: "official",
          supports: "institutional Chancellor route, adviser role and TENK-aligned categories",
          note: "Supports confidential adviser support, no adviser authority in RI processes, research misconduct/disregard categories and written notification to the Chancellor."
        },
        {
          ...
          note: "Entry point for ethics committees and research ethics services; boundary context, not misconduct handling."
        },
        {
          label: "TENK RI Guidelines 2023",
          url: "https://tenk.fi/sites/default/files/2023-05/RI_Guidelines_2023.pdf",
          type: "national guideline",
          supports: "TENK 2023 scope, categories and RI process",
          note: "Defines the Finnish RI/RCR framework followed by UH, including research misconduct, disregard for good research practices and the notification-preliminary-inquiry-investigation pathway."
        },
        {
        ...
        {
          label: "University of Helsinki ethical review of research on humans",
          url: "https://www.helsinki.fi/en/research/services-researchers/ethical-review-research/humanities-social-sciences-and-behavioural-sciences",
          type: "boundary route",
          supports: "medical and human-sciences ethics-review distinction",
          note: "Separates statutory medical-research ethics from human-sciences ethical pre-assessment; not RI misconduct handling."
        },
        {
          label: "University of Helsinki Research Ethics Committee in the Natural, Biological and Environmental Sciences and Engineering",
          url: "https://www.helsinki.fi/en/research/services-researchers/ethical-review-research/natural-biological-environmental-sciences-and-engineering",
          type: "boundary route",
          supports: "nature, environment and engineering ethics route",
          note: "Institutional ethics-review route for natural, biological, environmental sciences and engineering; not RI misconduct handling."
        },
        {
          label: "TENK 2026 NERE recommendation",
          url: "https://tenk.fi/sites/default/files/2026-06/Ethical%20principles%20for%20research%20involving%20nature%20and%20the%20environment.%20Recommendation%20of%20TENK%202026.pdf",
          type: "national recommendation",
          supports: "nature and environment ethical recommendation",
          note: "National recommendation and proposal for ethical review of research involving nature and the environment; not a formal RI misconduct code or local UH output route."
        },
        {
          label: "University of Helsinki ethical review of research on animals",
          url: "https://www.helsinki.fi/en/research/services-researchers/ethical-review-research/research-animals",
          type: "boundary route",
          supports: "animal-research ethics boundary",
          note: "Animal-research ethics route; keep separate from the Chancellor/TENK RI process."
        },
        {
      ...
      tags: ["official-source seed", "procedure only", "adviser network", "TENK", "national summaries", "Chancellor route", "NERE boundary"],
      caveats: [
        "University of Helsinki member validation confirms that no local annual RI statistics, anonymized local decisions or public case archive are available.",
        ...
        "Research-integrity advisers provide confidential support and early guidance but do not investigate or decide RI cases.",
        "Medical research ethics, human-sciences ethical pre-assessment, nature/environment ethics, animal research, clinical trials, data protection and open-science/data-management routes remain boundary regimes unless a source explicitly connects them to the RI process."
      ],
      reportNotes: [
        ...
        "Updated on 1 July 2026 from University of Helsinki member validation: the Chancellor route, adviser role, TENK 2023 categories/process, no-local-output finding and ethics-boundary distinctions were confirmed and sharpened."
      ],
      nextFollowUp: "No immediate classification change needed after member validation; keep monitoring UH annual reviews and TENK summaries for any future public local RI statistics, anonymized local decisions or institution-specific national summaries.",
      memberValidationQuestions: [
        "Confirmed by University of Helsinki member validation: the Chancellor notification route is the correct public first-instance framing.",
        "Show adviser role and function only: confidential advice, early-stage guidance and interpretation support; no investigation or decision role.",
        "Confirmed by University of Helsinki member validation: UH does not publish local annual RI statistics, anonymized local decisions or a public case archive.",
        "Confirmed by University of Helsinki member validation: TENK summaries should remain national-level output unless an individual summary is explicitly institution-specific.",
        "Keep medical research ethics, human-sciences ethics, nature/environment ethics, animal research, clinical trials, data protection and open-science/data-management routes as boundary material."
      ]
    }),
    member({
